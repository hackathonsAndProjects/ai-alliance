...
For my first CNN lab, I trained my model on PyTorch's MNIST dataset. The MNIST dataset is a database of handwritten digits that is commonly used for training varius image processing systems.
